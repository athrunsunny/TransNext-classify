...
parser.add_argument('--data', default=r'G:\deeplearning_dataset\ILSVRC2012_dataset', metavar='DIR',
                    help='path to dataset')
parser.add_argument('--model', default='transnext_small', type=str, metavar='MODEL',
...
def main():
    ...
    model = transnext_native.__dict__[args.model](drop_path_rate=args.drop_path,num_classes=args.num_classes)
